...
def test_user_subscription_creation():
    ...
    plan = SubscriptionPlan.objects.create(name="Plan Básico", description="test", price=10, duration_days=30)
...
def subscription_plans():
    return {
        'basic': SubscriptionPlan.objects.create(name='basic', price=10.00, duration_months=1),
        'standard': SubscriptionPlan.objects.create(name='standard', price=25.00, duration_months=3),
        'premium': SubscriptionPlan.objects.create(name='premium', price=80.00, duration_months=12),
    }
