    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('SuperAdmin', 'Super Admin'), ('Client-Admin', 'Client Admin'), ('Client-Staff', 'Client Staff'), ('Estilista', 'Estilista'), ('Cajera', 'Cajera'), ('Manager', 'Manager'), ('Utility', 'Utility')], max_length=20, null=True)),
